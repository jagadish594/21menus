      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function fetchData$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              searchURL = "https://api.nal.usda.gov/fdc/v1/foods/search?api_key=".concat(_myKeys_json__WEBPACK_IMPORTED_MODULE_7__.usda.key, "&query=").concat(state.inputQuery);
              console.log("url is: ", sear);
              _context.next = 4;
...
//# sourceMappingURL=index.js.7b73eeabc586d37caf83.hot-update.js.map