...
var FoodDetailsPage = function FoodDetailsPage() {
  ...
  if (foodDetails) {
    ...
    var _brandOwner = foodDetails.brandOwner,
        _ingredients = foodDetails.ingredients;
    console.log("length: ", _brandOwner.length);
  }
  ...
  }, "Back")), brandOwner.length > 0 && brandOwner ? __jsx("div", {
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 35,
...
//# sourceMappingURL=[id].js.832e9c29cc5e5da77562.hot-update.js.map